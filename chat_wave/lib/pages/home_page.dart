...
import 'package:chat_wave/pages/profile_page.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "You've not joined any groups, tap on the add icon to create a group or search from the top search button.",
            textAlign: TextAlign.center,
          )
        ],
      ),
